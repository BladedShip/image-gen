  ...
  return (
    <header className="flex p-5 justify-between sticky top-0 bg-[#2c2c2c] z-50 shadow-md">
      <div className="flex space-x-2 items-center">
        <img src="/test.png" width={30} height={30} alt="OpenAI Logo" />
        <div>
          <h1 className="font-bold">
            Image-Gen <span className="text-[#dbbadd]">by</span> Adithyan Jayakumar
          </h1>
          <h2 className="text-xs">
            Built with Next.js, OpenAI APIs and Microsoft Azure
          </h2>
        </div>
      </div>
